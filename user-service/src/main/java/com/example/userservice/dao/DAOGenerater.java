...
/**
 * @Author:penglong.huang
 * @Description:
 * @Date:Created in 16:17 2021/1/6
 */
public class DAOGenerater {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/springcloud_stack?useUnicode=true&useSSL=false&characterEncoding=utf8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("724888");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName(scanner("模块名"));
        pc.setParent("com.example.userservice.dao");
        pc.setEntity("po");
        pc.setService("dao");
